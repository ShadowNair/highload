...
| ----------------------- | --------------: | ----------: | ----------: |
| GET /catalog/search   |      68 375 309 |         791 |       6 331 |
| GET /game/{id}        |      46 637 007 |         540 |       4 318 |
| GET /library          |      124 200 000 |         1 438 |       8 625 |
| POST /auth/login      |      51 257 143 |         593 |       3 560 |
| POST /checkout/create |       2 830 866 |          33 |         262 |
| POST /payment/confirm |         843 032 |          10 |          78 |
| POST /review          |          21 076 |        0.24 |         2 |
| POST /cloudsave/sync  |      129 398 400 |         1 498 |       8 988 |
| GET /notifications | 8 575 342 | 99 | 596|
...
Для оценки сетевого трафика storefront-части можно использовать внешний бенчмарк веб-систем схожего класса. По данным HTTP Archive, в 2025 году median inner page имеет размер около 2.0 MB на desktop и 1.8 MB на mobile. Поскольку страницы каталога и карточки товара являются внутренними страницами storefront, для расчетной модели принимается 2 MB на один запрос как консервативная benchmark-based оценка.
|Тип запроса|Ср. размер ответа|
|:--:|:--:|
|search|2MB|
|product|2MB|
|login|5KB|
...
Traffic_cat = 68375309 * 2000000 * 8 / 86400 = 12.66 Gbps
Traffic_prod = 46637007 * 2000000 * 8 / 86400 = 8.64 Gbps

Traffic_store = Traffic_prod + Traffic_cat = 21.30 Gbps

...

|Тип трафика|Средний|Пиковый|
|:--:|:--:|:--:|
|Каталог и листинг игр|	12.66 Gbps|	101.30 Gbps|
|Карточки игр|	8.64 Gbps|	69.09 Gbps|
|Авторизация|	0.024 Gbps|	0.142 Gbps|
